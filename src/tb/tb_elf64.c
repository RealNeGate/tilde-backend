...
void tb_export_elf64(
    ...
    uint32_t* func_layout = malloc(m->functions.compiled_count * sizeof(uint32_t));
    ...
    Elf64_Ehdr header             = { .e_ident = { [EI_MAG0] = 0x7F, // magic number
                              [EI_MAG1]          = 'E',
                              [EI_MAG2]          = 'L',
                              [EI_MAG3]          = 'F',
    ...
    Elf64_Shdr strtab_section = { .sh_type = SHT_STRTAB, .sh_flags = 0, .sh_addralign = 1 };

    Elf64_Shdr code_section = {
        .sh_type = SHT_PROGBITS, .sh_flags = SHF_EXECINSTR | SHF_ALLOC, .sh_addralign = 16
    };

    Elf64_Shdr data_section = {
        .sh_type = SHT_PROGBITS, .sh_flags = SHF_ALLOC | SHF_WRITE, .sh_addralign = 16
    };

    Elf64_Shdr rodata_section = {
        .sh_type = SHT_PROGBITS, .sh_flags = SHF_ALLOC, .sh_addralign = 16
    };

    Elf64_Shdr bss_section = {
        .sh_type = SHT_NOBITS, .sh_flags = SHF_ALLOC | SHF_WRITE, .sh_addralign = 16
    };

    Elf64_Shdr stab_section = { .sh_type = SHT_SYMTAB,
        .sh_flags                        = 0,
        .sh_addralign                    = 1,
        .sh_link                         = 1,
    ...
    loop(i, m->functions.count) {
        ...
        Elf64_Sym sym = { .st_name = name_pos,
