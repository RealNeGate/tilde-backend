...
TB_API void   tb_inst_store(
      TB_Function* f, TB_DataType dt, TB_Reg addr, TB_Reg val, TB_CharUnits align);
...
TB_API void tb_inst_memset(
    TB_Function* f, TB_Reg dst, TB_Reg val, TB_Reg count, TB_CharUnits align);
...
TB_API void tb_inst_memcpy(
    TB_Function* f, TB_Reg dst, TB_Reg src, TB_Reg count, TB_CharUnits align);
...
TB_API TB_Reg tb_inst_vcall(
    TB_Function* f, TB_DataType dt, TB_Reg target, size_t param_count, const TB_Reg* params);
