...
TB_Function* test_div_i64(TB_Module* m) {
	TB_Function* func = tb_function_create(m, "main", TB_TYPE_I64);
	
	TB_Register a = tb_inst_param(func, TB_TYPE_I64);
	TB_Register b = tb_inst_param(func, TB_TYPE_I64);
	...
	TB_Register sum = tb_inst_div(
                                  func, TB_TYPE_I64,
                                  tb_inst_load(func, TB_TYPE_I64, ap, 4),
                                  tb_inst_load(func, TB_TYPE_I64, bp, 4),
                                  true
                                  );
    
	tb_inst_ret(func, TB_TYPE_I64, sum);
	return func;
}
...
TB_Function* test_add_i8(TB_Module* m) {
	TB_Function* func = tb_function_create(m, __FUNCTION__, TB_TYPE_I8);
	...
	tb_inst_ret(func, TB_TYPE_I8, sum);
	return func;
}

TB_Function* test_add_i16(TB_Module* m) {
	TB_Function* func = tb_function_create(m, __FUNCTION__, TB_TYPE_I16);
	...
	tb_inst_ret(func, TB_TYPE_I16, sum);
	return func;
}
...
TB_Function* test_mul_i64(TB_Module* m) {
	TB_Function* func = tb_function_create(m, __FUNCTION__, TB_TYPE_I64);
	
	TB_Register a = tb_inst_param(func, TB_TYPE_I64);
	TB_Register b = tb_inst_param(func, TB_TYPE_I64);
	TB_Register c = tb_inst_param(func, TB_TYPE_I64);
	...
	TB_Register factor = tb_inst_mul(
									 ...
									 tb_inst_mul(
												 func, TB_TYPE_I64,
												 tb_inst_load(func, TB_TYPE_I64, cp, 4),
												 tb_inst_load(func, TB_TYPE_I64, cp, 4),
	...
	tb_inst_ret(func, TB_TYPE_I64, factor);
	return func;
}
...
TB_Function* test_sat_uadd_i32(TB_Module* m) {
	...
	TB_Register b = tb_inst_param(func, TB_TYPE_I32);
	...
	TB_Register sum = tb_inst_add(
                                  func, TB_TYPE_I32,
                                  tb_inst_load(func, TB_TYPE_I32, ap, 4),
                                  tb_inst_load(func, TB_TYPE_I32, bp, 4),
                                  TB_SATURATED_UNSIGNED
                                  );
...
TB_Function* test_andor_i32(TB_Module* m) {
	...
	TB_Register a = tb_inst_param(func, TB_TYPE_I32);
	TB_Register b = tb_inst_param(func, TB_TYPE_I32);
	TB_Register c = tb_inst_param(func, TB_TYPE_I32);
	...
	TB_Register result = tb_inst_and(
									 ...
									 tb_inst_or(
												func, TB_TYPE_I32,
												tb_inst_load(func, TB_TYPE_I32, bp, 4),
												tb_inst_load(func, TB_TYPE_I32, cp, 4)
												)
									 );
...
TB_Function* test_add_f32(TB_Module* m) {
	...
	tb_inst_ret(func, TB_TYPE_F32, sum);
	return func;
}
...
TB_Function* test_muladd_f32(TB_Module* m) {
	...
	TB_Register a = tb_inst_param(func, TB_TYPE_F32);
	TB_Register b = tb_inst_param(func, TB_TYPE_F32);
	TB_Register c = tb_inst_param(func, TB_TYPE_F32);
	...
	TB_Register result = tb_inst_fadd(func, TB_TYPE_F32, 
									  tb_inst_fmul(
												   func, TB_TYPE_F32,
												   tb_inst_load(func, TB_TYPE_F32, ap, 4),
												   tb_inst_load(func, TB_TYPE_F32, bp, 4)
												   ),
									  tb_inst_load(func, TB_TYPE_F32, cp, 4)
									  );
	
	tb_inst_ret(func, TB_TYPE_F32, result);
	return func;
}

TB_Function* test_vadd_f32x4(TB_Module* m) {
	TB_Function* func = tb_function_create(m, __FUNCTION__, TB_TYPE_VEC_F32(4));
	
	TB_Register a = tb_inst_param(func, TB_TYPE_VEC_F32(4));
	TB_Register b = tb_inst_param(func, TB_TYPE_VEC_F32(4));
	
	TB_Register result = tb_inst_fadd(func, TB_TYPE_VEC_F32(4), a, b);
	
	tb_inst_ret(func, TB_TYPE_VEC_F32(4), result);
	return func;
}
...
TB_Function* test_vmuladd_f32x4(TB_Module* m) {
	...
	TB_Register a = tb_inst_param(func, TB_TYPE_VEC_F32(4));
	TB_Register b = tb_inst_param(func, TB_TYPE_VEC_F32(4));
	TB_Register c = tb_inst_param(func, TB_TYPE_VEC_F32(4));
...
TB_Function* test_locals_1(TB_Module* m) {
	...
	tb_inst_ret(func, TB_TYPE_I32, tb_inst_load(func, TB_TYPE_I32, local, 4));
	return func;
}
...
TB_Function* test_locals_2(TB_Module* m) {
	...
	tb_inst_ret(func, TB_TYPE_I32, tb_inst_load(func, TB_TYPE_I32, b, 4));
	return func;
}
...
TB_Function* test_bools_1(TB_Module* m) {
	TB_Function* func = tb_function_create(m, __FUNCTION__, TB_TYPE_BOOL);
	
	TB_Register local = tb_inst_local(func, 1, 1);
	tb_inst_store(func, TB_TYPE_BOOL, local, tb_inst_iconst(func, TB_TYPE_BOOL, 1), 1);
    
	tb_inst_ret(func, TB_TYPE_BOOL, tb_inst_load(func, TB_TYPE_BOOL, local, 4));
	return func;
}
...
TB_Function* test_foo(TB_Module* m) {
	...
	tb_inst_ret(func, TB_TYPE_I32, factor);
	return func;
}
...
TB_Function* test_entry(TB_Module* m) {
	...
	TB_Register al = tb_inst_load(func, TB_TYPE_I32, ap, 4);
